  ...
  return (
    <nav className="w-full flex items-center justify-between py-4 px-6 bg-chisco-black shadow-sm sticky top-0 z-50">
      ...
      <div className="hidden md:flex items-center space-x-4">
        <button
          onClick={onOpenCart}
          className="relative p-2 text-white hover:text-chisco-amber transition-colors rounded-md hover:bg-white/10"
        ...
        >
          ...
          {cartCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-chisco-amber text-chisco-black text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center min-w-[20px] border border-white">
          ...
          <div className="flex flex-col space-y-4 p-6">
            ...
            <div className="border-t border-white/20 pt-4">
              <button
                ...
                className="flex items-center w-full text-left text-white hover:text-chisco-amber transition-colors py-2"
              >
