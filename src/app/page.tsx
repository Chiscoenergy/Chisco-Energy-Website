...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-chisco-surface via-white to-chisco-surface/50">
      ...
      <section className="py-16 sm:py-20 lg:py-24 px-6 bg-gradient-to-br from-chisco-navy via-chisco-petrol to-chisco-navy relative overflow-hidden">
        {/* Background decorations */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-chisco-amber/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-2xl"></div>

        <div className="max-w-5xl mx-auto relative">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-chisco-amber/20 border border-chisco-amber/40 rounded-full mb-6">
              <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
              </svg>
              <span className="text-white text-sm font-semibold">Premium Service</span>
            </div>

            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white mb-4 lg:mb-6">
              Book a Consultation
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-4">
              Need expert advice on your energy needs? Our specialists are available for
              personalized consultations to help optimize your fuel supply chain and reduce costs.
            </p>

            {/* Paid consultation notice */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl mb-8">
              <svg className="w-5 h-5 text-chisco-amber" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="text-white/90 text-sm">Paid consultation • Pricing discussed via WhatsApp</span>
            </div>

            {/* Features */}
            <div className="grid sm:grid-cols-3 gap-4 mb-10 max-w-3xl mx-auto">
              <div className="flex items-center justify-center gap-2 text-white/80">
                <svg className="w-5 h-5 text-chisco-amber" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* CTA Button */}
            <a
              href="https://wa.me/2348166319502?text=Hello%20Chisco%20Energy%2C%20I%27d%20like%20to%20book%20a%20paid%20consultation%20for%20expert%20advice%20on%20my%20energy%20needs."
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center px-8 py-4 bg-chisco-amber text-chisco-black font-semibold rounded-2xl hover:bg-chisco-amber/90 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-chisco-amber/25"
            >
