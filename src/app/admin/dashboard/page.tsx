        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-4">
              <Link
                href="/admin/orders"
                className="text-chisco-navy hover:text-chisco-petrol font-medium text-sm"
              >
                View Orders →
              </Link>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-500 text-sm">Manage product catalog</p>
              </div>
            </div>
            <div className="mt-4">
              <Link
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-500 text-sm">View website analytics</p>
              </div>
            </div>
            <div className="mt-4">
              <Link
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-500 text-sm">AI-powered customer support</p>
              </div>
            </div>
            <div className="mt-4">
              <Link
